            ...
            for currentType, currentRegExp in zip(uniqueTypes, uniqueRegExps):
                ...
                for currentFile in fileNames:
                    ...
                    if matchedName is not None:
                        ...
                        if 'imageType' not in transformedName:
                            if 'fiducialImageType' in transformedName:
                                transformedName['imageType'] = transformedName.pop('fiducialImageType')
                        
                        if 'imagingRound' not in transformedName:
                            if 'fiducialImagingRound' in transformedName:
                                transformedName['imagingRound'] = transformedName.pop('fiducialImagingRound')
                            else:
